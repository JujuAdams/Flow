...
///      `FlowCompile()`.
/// 
/// Sets the program's internal clock for the purposes of adding instructions. Any instructions
/// that follow `FlowProgSetTime()` will use the clock time as its basis.
/// 
...
function FlowProgSetTime(_time, _useMilliseconds = false)
{
    ...
    {
        show_debug_message($"FlowProgSetTime({_time})");
    }
}